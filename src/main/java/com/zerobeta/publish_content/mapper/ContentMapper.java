...
public class ContentMapper {
    ...
    public ContentDto toDto(Content content) {
        ...
        dto.setWriterEmail(content.getWriter() != null ? content.getWriter().getEmail() : null);
    ...
    public Content toEntity(CreateContentDto dto, User writer, Set<Category> categories) {
        if (dto == null) return null;
        Content content = new Content();
        content.setTitle(dto.getTitle());
        content.setDetails(dto.getDetails());
    ...
    public List<Content> toEntityList(List<ContentDto> dtos, java.util.Map<String, User> writerMap, java.util.Map<String, Category> categoryMap) {
        ...
        return dtos.stream().map(dto -> {
            User writer = dto.getWriterEmail() != null ? writerMap.get(dto.getWriterEmail()) : null;
